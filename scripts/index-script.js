...
function createCard(cardData) {
  ...
  // Find the button element with class "cardButton" within the card
  const cardButton = card.querySelector(".cardButton");

  // Set up the button click event listener using the helper function
  setupCardButtonClickEvent(cardButton, cardData);
...
// Helper function to set up the button click event listener
function setupCardButtonClickEvent(cardButton, cardData) {
  cardButton.addEventListener("click", () => {
    handleCardButtonClick(cardData);
  });
}
